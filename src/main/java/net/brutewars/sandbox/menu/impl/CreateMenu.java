...
public final class CreateMenu extends Menu {
    ...
    public void placeItems() {
        setItem(1, new SkullBuilder()
                ...
                .onClick((event, bPlayer) -> createRequest(bPlayer, WorldType.AMPLIFIED)));
        ...
        setItem(2, new SkullBuilder()
                ...
                .onClick((event, bPlayer) -> createRequest(bPlayer, WorldType.FLAT)));
        ...
        setItem(3, new SkullBuilder()
                ...
                .onClick((event, bPlayer) -> createRequest(bPlayer, WorldType.NORMAL)));
    }

    private void createRequest(BPlayer bPlayer, WorldType type) {
        plugin.getBWorldManager().createRequest(bPlayer, type);
        plugin.getMenuManager().open(MenuIdentifier.STRUCTURE_GEN, bPlayer);
    }
